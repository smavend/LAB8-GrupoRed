...
<%@ page import="com.example.lab8.Beans.ElementoClase" %><%--
...
<jsp:useBean id="clase" type="java.lang.String" scope="request"/>
<jsp:useBean id="listaElementos" type="java.util.ArrayList<com.example.lab8.Beans.ElementoClase>" scope="request"/>

<html>
  <head>
    <meta charset="utf-8">
    <%DaoClase daoClase = new DaoClase();%>
    <title>Clase: <%=daoClase.buscarNombreXId(Integer.parseInt(clase))%></title>
        ...
        <div class="container py-4 my-5">
          ...
          <div class="row justify-content-between">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="widget">
                <h1 class="widget-title text-white d-inline-block mb-4">Clase: <%=daoClase.buscarNombreXId(Integer.parseInt(clase))%></h1>
                <table class="table table-bordered text-center text-white table-transparent">
                  <thead class="bg-dark">
                    <tr>
                      ...
                      <th class="h3" scope="col">Porct. de daño</th>
                      <th class="h3" scope="col">Debilidad o fortaleza</th>
                  ...
                  <tbody>
                    ...
                    <% int i = 1;
                      for (ElementoClase element : listaElementos){ %>
                    <tr>
                      <td><%=i%></td>
                      <td><%=daoClase.elementoBuscarNombreConId(element.getIdElemento())%></td>
                      <td><%=element.getPorcDano()%></td>
                      <td><%=element.getFortDeb()%></td>
                      <td><a href="<%=request.getContextPath()%>/Enemigos?id=editDano&clase=<%=clase%>&element=<%=element.getIdElemento()%>" class="btn btn-secondary">
