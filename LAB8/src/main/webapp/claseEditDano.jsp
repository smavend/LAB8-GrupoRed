<%@ page import="com.example.lab8.Daos.DaoClase" %><%--
...
<jsp:useBean id="clase" scope="request" type="java.lang.String"/>
<jsp:useBean id="element" scope="request" type="java.lang.String"/>
<html>
  <head>
    <meta charset="utf-8">
    <title>Edicion de Porc. Daño></title>
        ...
        <div class="row">
          <div class="col-md-10">
            <div class="contact-form bg-dark">
              ...
              <h1 class="text-white add-letter-space mb-5">Edita el porcentaje: <%=daoClase.buscarNombreXId(Integer.parseInt(clase))%> - <%=daoClase.elementoBuscarNombreConId(Integer.parseInt(element))%></h1>
              <form method="POST" class="needs-validation" action="<%=request.getContextPath()%>/Enemigos?post=danio" novalidate>
                <div class="row">
                  <div class="col-lg-2 col-md-12 col-sm-12 col-12" hidden>
                    <div class="form-group mb-5">
                      <label for="elemento" class="text-black-300">id Elemento</label>
                      <input type="text" id="elemento" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" name="elemento" value="<%=element%>">
                    </div>
                  </div>
                  <div class="col-lg-2 col-md-12 col-sm-12 col-12" hidden>
                    <div class="form-group mb-5">
                      <label for="idClase" class="text-black-300">id Clase</label>
                      <input type="text" id="idClase" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" name="idClase" value="<%=clase%>">
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="form-group mb-5">
                      <label for="porcentaje" class="text-black-300">Porcentaje</label>
                      <input type="number" id="porcentaje" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" name="porcentaje" value="<%=daoClase.hallarPorcentaje(Integer.parseInt(clase),Integer.parseInt(element))%>" required>
                      <p class="invalid-feedback">¡Se necesita un porcentaje!</p>
                    </div>
                  </div>
                  <div class="row justify-content-start">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                      <div class="d-block">
                        <a href="<%=request.getContextPath()%>/Enemigos?id=detail" class="btn btn-secondary">Cancelar</a>
                      </div>
                    </div>
                  </div>
                </div>
