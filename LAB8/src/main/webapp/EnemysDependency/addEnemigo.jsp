                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="contact-form bg-dark">
                                <h1 class="text-white add-letter-space mb-5">Agrega un nuevo enemigo</h1>
                                <form method="POST" class="needs-validation" action="<%=request.getContextPath()%>/Enemigos?post=add" novalidate>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-12 col-sm-12 col-12">
                                            <div class="form-group mb-5">
                                                ...
                                                <input type="number" id="ataque" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" name="ataque" required>
                                        ...
                                        <div class="col-lg-2 col-md-12 col-sm-12 col-12">
                                            <div class="form-group mb-5">
                                                ...
                                                <input type="number" id="experiencia" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" name="experiencia" required>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group mb-5">
                                                ...
                                                <input type="text" id="probObjeto" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" name="probObjeto" required>
